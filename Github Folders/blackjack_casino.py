# black jack in python wth pygame! Made by Nrxn (Liam)
import copy
import random
import pygame
...
def draw_game(act, record, result):
    ...
    if not act:
        ...
        credit_text = font.render('Made By Liam (Nrxn)', True, 'white')
        screen.blit(credit_text, (80, 800))

        credit_text = font.render('press deal hand to start :)', True, 'white')
        screen.blit(credit_text, (20, 400))
